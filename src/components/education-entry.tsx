...
export function EducationEntry({ education }: { education: Education }) {
  return (
    <div>
      {/* RESPONSIVE FIX: Flex column on mobile, Grid on desktop (md) */}
      <div className="flex flex-col md:grid md:grid-cols-4 gap-x-2 mb-2">
        <span className="text-xs text-zinc-500 mb-2 md:mb-0 md:mt-1">{education.year}</span>
